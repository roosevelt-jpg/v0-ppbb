  ...
  },
  {
    ...
    sections: [
      section('v1', 'Personal Details', 1, [
        field('firstName', 'text', 'First Name', 1),
        field('lastName', 'text', 'Last Name', 2),
        field('email', 'email', 'Email Address', 3),
        field('phone', 'phone', 'Mobile / WhatsApp Number', 4),
        field(
          'nationality',
          'select',
          'Nationality',
        ...
        field('emirate', 'select', 'Emirate / City', 6, true, [
          'Dubai',
          'Abu Dhabi',
          'Sharjah',
          'Ajman',
        ...
        field('gender', 'radio', 'Gender', 7, true, ['Male', 'Female']),
        field('ageRange', 'select', 'Age range', 8, true, [
          'Under 18',
          '18–24',
          '25–34',
          '35–44',
