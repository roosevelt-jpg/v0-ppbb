...
const businessMenuItems = [
  { label: 'Dashboard', href: '/business-admin/dashboard', icon: BarChart3 },
  { label: 'Profile', href: '/business-admin/profile', icon: Users },
  { label: 'Opportunities', href: '/business-admin/opportunities', icon: Briefcase },
  { label: 'Offers', href: '/business-admin/offers', icon: ShoppingBag },
  { label: 'Leads', href: '/business-admin/leads', icon: Zap },
  { label: 'Referrals', href: '/business-admin/referrals', icon: Share2 },
  { label: 'Partnerships', href: '/business-admin/partnerships', icon: Heart },
  { label: 'Marketplace', href: '/business-admin/marketplace', icon: LayoutGrid },
  { label: 'Payments', href: '/business-admin/payments', icon: DollarSign },
  { label: 'Analytics', href: '/business-admin/analytics', icon: TrendingUp },
]
