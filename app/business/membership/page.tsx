...
export default function BusinessMembershipPage() {
  ...
  if (loading || !user) {
    return <div className="p-8 text-neutral-500">Loading membership…</div>
  }

  return (
    <div className="min-h-screen bg-[#faf9f7]">
      <div className="bg-white border-b border-[#e4e1da] px-4 py-4 sm:px-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-xl font-bold text-neutral-900">Business membership</h1>
