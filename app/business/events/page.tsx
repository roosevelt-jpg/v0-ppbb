      ...
      <div style={{ flex: 1, padding: '40px' }}>
        ...
        {loading ? (
          ...
          <div style={{ display: 'grid', gap: '16px' }}>
            {events.map((event) => (
              <Card key={event.id} style={{ backgroundColor: '#ffffff', borderColor: '#e4e1da', padding: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  <button
                    onClick={() => router.push(`/business/events/${event.id}`)}
                    style={{
                      padding: '8px 12px',
