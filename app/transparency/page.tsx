        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white p-6 sm:p-8 rounded-lg border border-[#e4e1da]">
            ...
            <div className="space-y-4 text-sm sm:text-base text-[#333333]">
              ...
              <p className="text-[#888888] pt-4 border-t border-[#e4e1da]">
                Questions about our transparency? Contact our team at{' '}
                <a href="mailto:transparency@passiveblessings.ae" className="text-[#3498db] hover:underline">
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 font-playfair">Help Us Make a Greater Impact</h2>
            <p className="text-base sm:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Every donation helps us support our community. Together, we can achieve more.
            </p>
