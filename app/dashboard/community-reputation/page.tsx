...
export default function CommunityReputationPage() {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        >
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '32px', alignItems: 'center' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#111111', margin: 0, textTransform: 'capitalize' }}>
            ...
            {/* Score */}
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '48px', fontWeight: 700, color: '#111111', marginBottom: '8px' }}>
                {userReputation.score.toLocaleString()}
              </div>
              <div style={{ fontSize: '13px', color: '#666' }}>Reputation Points</div>
            </div>

            {/* Contribution Breakdown */}
            <div>
              <h4 style={{ fontSize: '13px', fontWeight: 700, color: '#111111', marginBottom: '12px', margin: '0 0 12px 0' }}>
                Your Contributions
              </h4>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
                  <span style={{ color: '#666' }}>Volunteering</span>
                  <span style={{ fontWeight: 600, color: '#111111' }}>
                    {userReputation.contributions.volunteering}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
                  <span style={{ color: '#666' }}>Donations</span>
                  <span style={{ fontWeight: 600, color: '#111111' }}>
                    {userReputation.contributions.donations}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
                  <span style={{ color: '#666' }}>Referrals</span>
                  <span style={{ fontWeight: 600, color: '#111111' }}>
                    {userReputation.contributions.referrals}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
                  <span style={{ color: '#666' }}>Community</span>
                  <span style={{ fontWeight: 600, color: '#111111' }}>
          ...
          {userReputation.badges && userReputation.badges.length > 0 && (
            <div style={{ marginTop: '24px', paddingTop: '24px', borderTop: '1px solid #eee' }}>
              <h4 style={{ fontSize: '13px', fontWeight: 700, color: '#111111', marginBottom: '12px', margin: 0 }}>
                Earned Badges
              </h4>
      ...
      <div style={{ padding: '24px', backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #eee' }}>
        <h2 style={{ fontSize: '24px', fontWeight: 700, color: '#111111', marginBottom: '24px', margin: 0 }}>
          Top Community Members
        </h2>

        {leaderboard.length === 0 ? (
          <p style={{ color: '#999', fontSize: '13px' }}>No leaderboard data yet</p>
        ) : (
                ...
                {leaderboard.map((entry) => (
                  <tr
                    ...
                    style={{
                      ...
                      backgroundColor: entry.userId === user?.id ? '#f9f9f9' : 'transparent',
                    }}
                  >
                    <td style={{ padding: '12px' }}>
                      <span
                        style={{
                          ...
                          height: '32px',
                          borderRadius: '50%',
                          backgroundColor: entry.rank <= 3 ? '#FFD700' : '#e0e0e0',
                          color: '#111111',
                          fontWeight: 700,
                          fontSize: '14px',
                        }}
                    ...
                    <td style={{ padding: '12px', fontSize: '13px', fontWeight: 600, color: '#0066CC' }}>
      ...
      {/* Info Box */}
      <div style={{ marginTop: '32px', padding: '24px', backgroundColor: '#f9f9f9', borderRadius: '8px', borderLeft: '4px solid #0066CC' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 600, color: '#111111', marginBottom: '12px', margin: 0 }}>
          How Reputation Works
        </h3>
        <ul style={{ margin: 0, paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <li style={{ fontSize: '13px', color: '#666' }}>Earn points through volunteering, donations, referrals, and community engagement</li>
          <li style={{ fontSize: '13px', color: '#666' }}>Level up: Bronze → Silver → Gold → Platinum → Diamond</li>
          <li style={{ fontSize: '13px', color: '#666' }}>Unlock special badges and recognition in the community</li>
          <li style={{ fontSize: '13px', color: '#666' }}>Access exclusive member benefits at higher levels</li>
        </ul>
      </div>
    </div>
  )
