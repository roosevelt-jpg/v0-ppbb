                ...
                <div className="p-4 border-b border-neutral-200">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-xs text-neutral-500 mt-1">User Role: {selectedConv.userRole}</p>
                      <p className="text-xs text-neutral-500">Category: {selectedConv.category}</p>
                    </div>
                    <div className="flex gap-2">
                      <select
                        value={selectedConv.status}
                        onChange={e => updateConversationStatus(selectedConv.id, e.target.value)}
