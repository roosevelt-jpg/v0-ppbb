          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map(community => {
              ...
              >
                ...
                <div className="flex flex-nowrap items-center gap-1 mt-auto">
                  <Link
                    href={`/admin/communities/${community.id}/groups`}
                    className="inline-flex items-center gap-1 h-6 px-2 bg-black text-white rounded-md text-[11px] font-semibold hover:bg-neutral-800 whitespace-nowrap pb-compact-btn"
                  >
                  ...
                  <Link
                    ...
                    className="pb-compact-btn inline-flex items-center justify-center h-6 w-6 rounded-md bg-black text-white hover:bg-neutral-800 [&_svg]:h-3 [&_svg]:w-3"
                    title="Edit"
                    aria-label="Edit"
                  >
