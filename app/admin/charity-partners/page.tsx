...
export default function CharityPartnersPage() {
  ...
  const btnSecondary =
    'min-h-[44px] bg-white dark:bg-card text-black dark:text-foreground border border-neutral-300 dark:border-border hover:bg-neutral-50 px-4 py-2 rounded text-sm font-semibold'
  const btnDanger =
      ...
      <div className="space-y-6" style={{ fontFamily: 'Inter, sans-serif' }}>
        <div className="bg-white dark:bg-card rounded-lg p-4 sm:p-6 shadow-sm border border-neutral-100 dark:border-border">
          ...
          <form onSubmit={handleAddPartner} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            />
            <p className="md:col-span-2 text-xs text-neutral-500 dark:text-muted-foreground -mt-2">
        ...
        <div className="bg-white dark:bg-card rounded-lg p-4 sm:p-6 shadow-sm border border-neutral-100 dark:border-border">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <Building2 className="w-10 h-10 text-neutral-300 dark:text-muted-foreground mx-auto mb-3" />
              <p className="text-neutral-600 dark:text-muted-foreground">No charity partners yet</p>
            ...
            <>
              <div className="md:hidden space-y-3">
                {partners.map((p) => (
                  <div key={p.id} className="border rounded-lg p-4 space-y-2">
                    ...
                    <p className="text-sm text-neutral-600 dark:text-muted-foreground line-clamp-2">{p.description}</p>
              ...
              <div className="hidden md:block admin-table-scroll min-w-0">
                <table className="w-full text-sm min-w-[720px]">
                  ...
                  <tbody>
                    {partners.map((p) => (
                      <tr key={p.id} className="border-b border-neutral-100 dark:border-border">
                        ...
                        <td className="py-3 pr-3 text-xs space-y-1">
                          {p.zakatPaymentLink ? (
                            ...
                            <span className="text-neutral-400 dark:text-muted-foreground block">Zakat —</span>
                          )}
                          {p.sadaqahPaymentLink ? (
                            ...
                            <span className="text-neutral-400 dark:text-muted-foreground block">Sadaqah —</span>
                          )}
