    ...
    >
      <div className="grid gap-6 md:grid-cols-2">
        <div className="bg-white dark:bg-card border border-gray-200 dark:border-border rounded-lg p-6">
          <Share2 className="w-8 h-8 text-gray-700 dark:text-foreground mb-3" />
          ...
          <Link
            ...
            className="h-7 min-h-0 inline-flex items-center gap-2 px-4 py-2 bg-black text-white rounded-lg text-sm font-medium"
          >
        ...
        <div className="bg-white dark:bg-card border border-gray-200 dark:border-border rounded-lg p-6">
          ...
          <ul className="text-sm text-gray-600 dark:text-muted-foreground space-y-2">
            <li>
              <code className="text-xs bg-gray-100 dark:bg-muted px-1 rounded">referrals</code> — member-to-business conversion records
            </li>
            <li>
              <code className="text-xs bg-gray-100 dark:bg-muted px-1 rounded">businessReferrals</code> — per-business referral aggregates
            </li>
          </ul>
